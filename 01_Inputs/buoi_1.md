...
Đề: Đạo hàm của hàm số $y=3x^3-2x^2+2019$ là:
A. $y^{\prime}=6x^2-4x$.
B. $y^{\prime}=9x^2+4x$.
C. $y^{\prime}=9x^2-4x$.
D. $y^{\prime}=9x^2-2x$.
Lời giải: Áp dụng công thức đạo hàm tổng và đạo hàm cơ bản ta có: $y^{\prime} = (3x^3)^{\prime} - (2x^2)^{\prime} + (2019)^{\prime} = 9x^2 - 4x$.

## CÂU 7  | level: tb | đáp án: D
Đề: Cho hàm số $f(x)=x^3-3x^2-9x+2018$. Tìm tập nghiệm của phương trình $f^{\prime}(x)=0$.
A. $S=\{1; 3\}$.
B. $S=\{-1; -3\}$.
C. $S=\{1; -3\}$.
D. $S=\{-1; 3\}$.
Lời giải: Ta có $f^{\prime}(x) = 3x^2 - 6x - 9$. Phương trình $f^{\prime}(x) = 0 \Leftrightarrow 3x^2 - 6x - 9 = 0 \Leftrightarrow x = -1 \vee x = 3$. Vậy tập nghiệm $S = \{-1; 3\}$.
...
## CÂU 14  | level: tb | đáp án: D
Đề: Tính đạo hàm $f^{\prime}(x)$ của hàm số $f(x)=\dfrac{2x+1}{x-1}$.
A. $f^{\prime}(x)=\dfrac{1}{(x-1)^{2}}$.
B. $f^{\prime}(x)=\dfrac{3}{(x-1)^{2}}$.
C. $f^{\prime}(x)=-\dfrac{1}{(x-1)^{2}}$.
D. $f^{\prime}(x)=-\dfrac{3}{(x-1)^{2}}$.
Lời giải: Ta có $f^{\prime}(x) = \dfrac{(2x+1)^{\prime}(x-1) - (2x+1)(x-1)^{\prime}}{(x-1)^2} = \dfrac{2(x-1) - (2x+1)}{(x-1)^2} = \dfrac{-3}{(x-1)^2}$.

## CÂU 15  | level: tb | đáp án: A
Đề: Cho hàm số $y=\dfrac{-2x^{2}+x-7}{x^2+3}$. Tìm tập nghiệm của phương trình $y^{\prime}=0$.
A. $S=\{-1; 3\}$.
B. $S=\{1; 3\}$.
C. $S=\{-3; 1\}$.
D. $S=\{-3; -1\}$.
Lời giải: Ta tính được đạo hàm $y^{\prime} = \dfrac{(-4x+1)(x^2+3) - (-2x^2+x-7)(2x)}{(x^2+3)^2} = \dfrac{-x^2+2x+3}{(x^2+3)^2}$. Phương trình $y^{\prime}=0 \Leftrightarrow -x^2+2x+3=0 \Leftrightarrow x=-1 \vee x=3$. Vậy $S=\{-1; 3\}$.
...
## CÂU 20  | level: tb | đáp án: A
Đề: Cho hàm số $y=2\sqrt{2x^2+x-5}$. Tính giá trị $y^{\prime}(2)$.
A. $y^{\prime}(2)=\dfrac{9}{\sqrt{5}}$.
B. $y^{\prime}(2)=2\sqrt{5}$.
C. $y^{\prime}(2)=\dfrac{9}{2\sqrt{5}}$.
D. $y^{\prime}(2)=\sqrt{5}$.
Lời giải: Ta có: $y^{\prime} = 2 \cdot \dfrac{(2x^2+x-5)^{\prime}}{2\sqrt{2x^2+x-5}} = \dfrac{4x+1}{\sqrt{2x^2+x-5}}$. Thay $x=2$ vào được $y^{\prime}(2)=\dfrac{4 \cdot 2+1}{\sqrt{2 \cdot 2^2+2-5}} = \dfrac{9}{\sqrt{5}}$.

## CÂU 21  | level: tb | đáp án: A
Đề: Đạo hàm của hàm số $y=x^{2}-3\sqrt{x}+\dfrac{1}{x}$ với $x>0$ là:
A. $y^{\prime}=2x-\dfrac{3}{2\sqrt{x}}-\dfrac{1}{x^{2}}$.
B. $y^{\prime}=2x+\dfrac{3}{2\sqrt{x}}+\dfrac{1}{x^{2}}$.
C. $y^{\prime}=2x-\dfrac{3}{2\sqrt{x}}+\dfrac{1}{x^{2}}$.
D. $y^{\prime}=2x+\dfrac{3}{2\sqrt{x}}-\dfrac{1}{x^{2}}$.
Lời giải: Ta có $y^{\prime} = (x^2)^{\prime} - 3(\sqrt{x})^{\prime} + \left(\dfrac{1}{x}\right)^{\prime} = 2x - 3 \cdot \dfrac{1}{2\sqrt{x}} - \dfrac{1}{x^2} = 2x - \dfrac{3}{2\sqrt{x}} - \dfrac{1}{x^2}$.

## CÂU 22  | level: tb | đáp án: A
Đề: Cho hàm số $f(x)=\sqrt{2x-1}$. Đặt $g(x)=f(1)+4\left(x^{2}-2\right)f^{\prime}(1)$. Tính giá trị của $g(2)$.
A. $g(2) = 9$.
B. $g(2) = 5$.
C. $g(2) = 1$.
D. $g(2) = 8$.
Lời giải: Ta có $f(1) = \sqrt{2 \cdot 1 - 1} = 1$. Đạo hàm $f^{\prime}(x) = \dfrac{(2x-1)^{\prime}}{2\sqrt{2x-1}} = \dfrac{1}{\sqrt{2x-1}} \Rightarrow f^{\prime}(1) = 1$. Thay vào biểu thức $g(2) = f(1) + 4(2^2-2)f^{\prime}(1) = 1 + 4(2)(1) = 9$.


### DẠNG 4: ĐẠO HÀM HÀM LƯỢNG GIÁC

## CÂU 23  | level: tb | đáp án: A
...
Đề: Đạo hàm của hàm số $y=2\sin x+3\cos 2x$ là:
A. $y^{\prime}=2\cos x+3\sin 2x$.
B. $y^{\prime}=2\cos x-3\sin 2x$.
C. $y^{\prime}=2\cos x+6\sin 2x$.
D. $y^{\prime}=2\cos x-6\sin 2x$.
Lời giải: Ta có $y^{\prime} = 2(\sin x)^{\prime} + 3(\cos 2x)^{\prime} = 2\cos x + 3 \cdot (-2\sin 2x) = 2\cos x - 6\sin 2x$.

## CÂU 30  | level: tb | đáp án: C
Đề: Tính đạo hàm của hàm số $y=\sin(\sin x)$.
A. $y^{\prime}=\cos(\sin x)$.
B. $y^{\prime}=\cos(\cos x)$.
C. $y^{\prime}=\cos x \cdot \cos(\sin x)$.
D. $y^{\prime}=\cos x \cdot \cos(\cos x)$.
Lời giải: Áp dụng công thức đạo hàm hàm hợp ta có $y^{\prime} = (\sin x)^{\prime} \cdot \cos(\sin x) = \cos x \cdot \cos(\sin x)$.
